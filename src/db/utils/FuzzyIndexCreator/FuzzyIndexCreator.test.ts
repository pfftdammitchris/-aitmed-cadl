  ...
  describe('FuzzyIndexCreator', () => {
    describe('initialMapping', () => {
      test('it should create a map of initial string', () => {
        ...
        const initialMapping_TestStr = fuzzyIndexCreator.initialMapping(
          '123!ijoi4343*@#{}'
        )
    ...
    describe('toFuzzyInt64', () => {
      test('should correct map hex to int representation', () => {
        ...
        const initialMapping_Christina = fuzzyIndexCreator2.initialMapping(
          'Christina'
        )
        const initialMapping_TestStr = fuzzyIndexCreator2.initialMapping(
          '123!ijoi4343*@#{}'
        )
        const fuzzyInt_Christina = fuzzyIndexCreator2.toFuzzyInt64(
          initialMapping_Christina
        )
        const fuzzyInt_Hello = fuzzyIndexCreator2.toFuzzyInt64(
          initialMapping_Hello
        )
    ...
    describe('toFuzzyHex', () => {
      test('should correct map string to hex representation', () => {
        ...
        const fuzzyInt_Hello = fuzzyIndexCreator2.toFuzzyHex(
          initialMapping_Hello
        )
