export default class CheckStopWord {
  private stopWords: string =
    ...
    "himself his how how's i i'd i'll i'm i've if in into is isn't it it's its itself let's " +
    ...
    "you've your yours yourself yourselves json"
  ...
  isStopWord(aWord: string) {
    if (this.stopWordMap[aWord]) return true
    return false
  }

  FilterStopWords(content: string) {
